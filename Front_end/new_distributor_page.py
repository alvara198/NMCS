...
def new_distributor_page():
    root = Tk()
    root.title("New Distributor Window")

    root.geometry("400x600")

    #labels
    title = Label(root, text="New Distributor", font=("Arial", 36))
    product_name_title = Label(root, text="New Distributor Name:", font=("Arial", 16))
    product_unit_price_title = Label(root, text="New Distributor Last Name:", font=("Arial", 16))
    product_code_title = Label(root, text="New Distributor Gender:", font=("Arial", 16))
    product_code_title = Label(root, text="New Distributor :", font=("Arial", 16))
    product_code_title = Label(root, text="New Distributor Gender:", font=("Arial", 16))
    product_code_title = Label(root, text="New Distributor Gender:", font=("Arial", 16))
